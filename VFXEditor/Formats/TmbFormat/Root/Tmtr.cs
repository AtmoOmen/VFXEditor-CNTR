...
namespace VfxEditor.TmbFormat {
    public class Tmtr : TmbItemWithTime, IUiItem {
        ...
        private readonly ParsedByteBool LuaAssigned = new( "使用 Lua 条件", defaultValue: false );
        ...
        private void ImportDialog() {
            FileDialogManager.OpenFileDialog( "选择文件", "TMB Entry{.tmbentry},.*", ( bool ok, string res ) => {
                if( !ok ) return;
                try {
