...
namespace VfxEditor.Formats.TextureFormat {
    ...
    public class TextureDataFile : Lumina.Data.FileResource {
        ...
        public void SavePngDialog() {
            FileDialogManager.SaveFileDialog( "选择保存位置", ".png", "ExportedTexture", "png", ( bool ok, string res ) => {
                if( !ok ) return;
                SaveAsPng( res );
            } );
        }
        ...
        public void SaveDdsDialog() {
            FileDialogManager.SaveFileDialog( "选择保存位置", ".dds", "ExportedTexture", "dds", ( bool ok, string res ) => {
                if( !ok ) return;
                SaveAsDds( res );
            } );
        }
        ...
        public void SaveTexDialog( string ext ) {
            FileDialogManager.SaveFileDialog( "选择保存位置", $".{ext}", "ExportedTexture", ext, ( bool ok, string res ) => {
                if( !ok ) return;
