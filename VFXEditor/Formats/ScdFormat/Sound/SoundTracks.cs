...
namespace VfxEditor.ScdFormat {
    public class SoundTracks {
        ...
        public void Draw() {
            ...
            for( var idx = 0; idx < Tracks.Count; idx++ ) {
                if( ImGui.CollapsingHeader( $"轨道 #{idx}", ImGuiTreeNodeFlags.DefaultOpen ) ) {
    ...
    public class SoundTrackInfo {
        public readonly ParsedShort TrackIdx = new( "轨道序列" );
        public readonly ParsedShort AudioIdx = new( "音频序列" );
